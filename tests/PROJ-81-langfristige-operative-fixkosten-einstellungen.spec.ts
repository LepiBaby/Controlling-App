...
//   /dashboard/langfristige-planung/[versionId]/operative-fixkosten-einstellungen
...
const PAGE_URL = `/dashboard/langfristige-planung/${SAMPLE_VERSION_ID}/operative-fixkosten-einstellungen`

// ─── Seitenexistenz (kein 404) ───────────────────────────────────────────────

test('versionsgebundene Operative-Fixkosten-Route liefert keinen 404-Fehler', async ({ page }) => {
...
test('unauthenticated user is redirected from langfristige Operative Fixkosten to /login', async ({ page }) => {
...
// ─── Regression: Kurzfristige Operative Fixkosten weiterhin erreichbar ───────
