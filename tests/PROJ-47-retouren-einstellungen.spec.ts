...
// API-Integrationstests (401/400/200) sind durch Vitest in route.test.ts abgedeckt (39 Tests).

// ─── Seitenexistenz (kein 404) ───────────────────────────────────────────────

test('/dashboard/kurzfristige-planung/retouren-einstellungen liefert keinen 404-Fehler', async ({ page }) => {
...
test('unauthenticated user is redirected from /dashboard/kurzfristige-planung/retouren-einstellungen to /login', async ({ page }) => {
  await page.goto('/dashboard/kurzfristige-planung/retouren-einstellungen')
...
// Navigation & Einstieg:
//   ✅ Linke Navigation im Bereich "Kurzfristige Planung" zeigt Eintrag "Retoureneinstellungen"
//   ✅ Kachel "Retoureneinstellungen" auf /dashboard/kurzfristige-planung vorhanden
...
//
// Plattform-Einstellungen (oberhalb der Tabelle, 4 Felder):
...
//   ✅ Erstattung Verkaufsgebühr (%)-Feld vorhanden (Dezimalzahl 0–100)
//   ✅ Erstattung-Änderung wird nach onBlur gespeichert
//   ✅ Plattform-Einstellungen sind unabhängig je Plattform gespeichert
//
// Produkttabelle (4 Spalten):
//   ✅ Spalten: Produkt (read-only) | Berechnungsart Retourenquote | Rückversandkosten (€ netto) | Retourenhandling-Kosten (€ netto)
//   ✅ Je Plattform-Tab eine Zeile pro Produkt (level=1, type=produkte)
//   ✅ Leerzustand wenn keine Produkte: Hinweis + Link zum KPI-Modell
//
// Berechnungsart-Dropdown (je Produktzeile):
//   ✅ Optionen: Keine / Mittelwert 14 Tage / 30 Tage / 60 Tage / 90 Tage
//   ✅ Standardwert: "Keine" bei noch nicht gespeicherter Kombination
//   ✅ Änderung wird sofort gespeichert (onChange)
