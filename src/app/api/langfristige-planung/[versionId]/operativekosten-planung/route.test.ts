...
const URL_BASE = `http://localhost/api/langfristige-planung/${VERSION_ID}/operativekosten-planung`
...
function put(body: unknown, id = VERSION_ID) {
  return PUT(
    new Request(`http://localhost/api/langfristige-planung/${id}/operativekosten-planung`, {
      method: 'PUT',
...
describe('GET /api/langfristige-planung/[versionId]/operativekosten-planung', () => {
...
describe('PUT /api/langfristige-planung/[versionId]/operativekosten-planung', () => {
