...
const URL_BASE = `http://localhost/api/langfristige-planung/${VERSION_ID}/umsatzausgaben`
...
function put(body: unknown, id = VERSION_ID) {
  return PUT(
    new Request(`http://localhost/api/langfristige-planung/${id}/umsatzausgaben`, {
      method: 'PUT',
...
describe('GET /api/langfristige-planung/[versionId]/umsatzausgaben', () => {
...
describe('PUT /api/langfristige-planung/[versionId]/umsatzausgaben', () => {
...
describe('DELETE /api/langfristige-planung/[versionId]/umsatzausgaben', () => {
