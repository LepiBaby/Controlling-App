...
// PROJ-77: Warenkosten & Zollsatz je Produkt (versionsgebunden).

const TABLE = 'langfristige_produktinformationen_produktkosten'
const COLS = 'id, produkt_id, warenkosten, zollsatz_pct'
