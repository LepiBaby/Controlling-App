...
// Aktueller Bestand je Produkt (versionsgebunden).

const TABLE = 'langfristige_produktinformationen_aktueller_bestand'
const COLS = 'id, produkt_id, bestand'

const UpsertSchema = z.object({
  produkt_id: z.string().uuid(),
  bestand: z.number().int().min(0).nullable().optional(),
})
    ...
    .upsert(
      {
        ...
        bestand: parsed.data.bestand ?? null,
