...
describe('GET /api/finanzierungs-planung', () => {
...
describe('PUT /api/finanzierungs-planung', () => {
  function req(body: unknown) {
    return new Request('http://localhost/api/finanzierungs-planung', {
      method: 'PUT',
...
describe('DELETE /api/finanzierungs-planung', () => {
  function buildDelete(query = '') {
    return new Request(`http://localhost/api/finanzierungs-planung${query ? '?' + query : ''}`, {
      method: 'DELETE',
    })
  }
