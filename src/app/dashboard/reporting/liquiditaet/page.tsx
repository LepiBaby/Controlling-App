...
import { ReportingLiquiditaetMatrix } from '@/components/reporting-liquiditaet-matrix'
import { ReportingLiquiditaetChart } from '@/components/reporting-liquiditaet-chart'
import {
  useReportingLiquiditaet,
  type ReportGranularitaet,
} from '@/hooks/use-reporting-liquiditaet'

export default function ReportingLiquiditaetPage() {
  const {
    ...
    <div className="flex min-h-screen flex-col">
      <header className="border-b bg-background px-6 py-4">
        <div className="flex items-center gap-2">
          <NavSheet />
          <h1 className="text-lg font-semibold">Liquiditätsreport</h1>
        </div>
      </header>
      ...
      <main className="flex-1 p-6">
        <div className="w-full space-y-6">
          ...
          {/* Cashflow-Liniendiagramm */}
          <ReportingLiquiditaetChart
