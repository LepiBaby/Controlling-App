...
// PROJ-96: Umsatz-Matrix der Langfristigen Planung — feste Kaskade (Brutto-Umsatz …
// Netto-Umsatz), Drill-Down je Produkt, sticky erste Spalte, drei Ansichtsmodi.
// Aufbau und Stil exakt wie die Rentabilitätsauswertung-Matrix (PROJ-95).
...
function flatten(nodes: UaNode[], expandedIds: Set<string>, indent: number, out: FlatRow[]) {
...
export function LangfristigeUmsatzauswertungMatrix({ model, anzeigemodus }: Props) {
  ...
  // ── Betragsselektion (analog PROJ-95) ──
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              {rows.map((row, idx) => {
                ...
                const isLeafDetail = row.kind === 'produkt'
