...
import type { UaModel } from '@/hooks/use-langfristige-umsatzauswertung'
...
// PROJ-96: Absatztabelle (zwischen Diagramm und Haupttabelle) — analog PROJ-95/PROJ-33.
// „Absatz gesamt" (aufklappbar → je Produkt), Monats-/Jahresspalten, ganze Zahlen.
export function LangfristigeUmsatzauswertungAbsatztabelle({ model }: Props) {
