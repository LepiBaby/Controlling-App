...
interface Props {
  ...
  eintragToEdit: FinanzierungsEintrag | null
  kategorien: KpiCategory[]
  onSave: (input: FinanzierungsInput) => Promise<void>
}

export function FinanzierungsEinstellungenFormularDialog({
  open,
  onOpenChange,
  eintragToEdit,
  kategorien,
  ...
  const [ustSatz, setUstSatz] = useState<UstSatz>('0')
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{isEdit ? 'Finanzierung bearbeiten' : 'Finanzierung anlegen'}</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            ...
            {kategorien.length === 0 ? (
              <p className="text-sm text-muted-foreground">
                Keine Gruppen gefunden. Bitte zuerst die Kategorie „Finanzierung" im KPI-Modell anlegen.
              </p>
            ) : (
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              placeholder="z. B. Bankkredit Betriebsmittel"
              maxLength={100}
            />
          </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSave} disabled={saving || kategorien.length === 0}>
