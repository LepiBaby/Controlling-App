                  ...
                  <TableCell
                    className={`text-right font-medium whitespace-nowrap cursor-pointer select-none ${
                      selectedCells.has(`${z.quelle}-${z.id}_betrag`)
                        ...
                        : `hover:bg-blue-50 dark:hover:bg-blue-950/20 ${Number(z.betrag) >= 0 ? 'text-green-600' : 'text-red-600'}`
                    }`}
                    onMouseDown={e => handleCellMouseDown(e, `${z.quelle}-${z.id}_betrag`, Number(z.betrag))}
                    onMouseEnter={() => handleCellMouseEnter(`${z.quelle}-${z.id}_betrag`, Number(z.betrag))}
                  >
