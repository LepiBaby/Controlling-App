...
interface Props {
  eintraege: FinanzierungsEintrag[]
  onEdit: (eintrag: FinanzierungsEintrag) => void
  onDelete: (id: string) => Promise<void>
}

export function FinanzierungsEinstellungenTabelle({ eintraege, onEdit, onDelete }: Props) {
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-right">Zahlungsziel (Tage)</TableHead>
          ...
          {eintraege.map(e => (
            <TableRow key={e.id}>
              ...
              <TableCell className="text-right tabular-nums">
                {e.zahlungsziel_tage != null ? e.zahlungsziel_tage : '–'}
              </TableCell>
              <TableCell className="text-right tabular-nums">
              ...
              <TableCell>
                <div className="flex gap-1">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Finanzierungseintrag löschen?</AlertDialogTitle>
                        <AlertDialogDescription>
