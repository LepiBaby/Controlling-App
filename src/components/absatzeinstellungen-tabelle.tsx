...
import {
  ...
  type AbsatzEinstellung,
  type Berechnungsart,
  BERECHNUNGSARTEN,
  BERECHNUNGSART_LABELS,
  isGewichtet,
} from '@/hooks/use-absatz-einstellungen'
import { useToast } from '@/hooks/use-toast'

// --- Einzelne Produktzeile ---

function AbsatzEinstellungZeile({
  produkt,
  plattformId,
  einstellung,
    ...
    return (
      <div className="rounded-lg border bg-muted/30 p-8 text-center space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          Bitte zuerst Produkte im KPI-Modell anlegen, bevor Absatzeinstellungen gepflegt werden können.
        </p>
...
export function AbsatzeinstellungenTabelle() {
  ...
  if (sortedPlattformen.length === 0) {
    return (
      <div className="rounded-lg border bg-muted/30 p-8 text-center space-y-3">
        ...
        <p className="text-sm text-muted-foreground">
          Bitte zuerst Sales-Plattformen im KPI-Modell anlegen, bevor Absatzeinstellungen gepflegt werden können.
        </p>
        <a href="/dashboard/kpi-modell">
          <Button variant="outline" size="sm" className="mt-2">
            Zum KPI-Modell
