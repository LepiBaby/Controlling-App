...
import type { AuswertungColumn, AuswertungRow } from '@/hooks/use-langfristige-liquiditaetsauswertung'
...
export function LangfristigeLiquiditaetsauswertungChart({ columns, rows, loading }: Props) {
